# peyton_huber_coppock_2022/maintained/figure_3_conjoint_correspondence.R
# Output: maintained/output/figure_3_conjoint_correspondence.pdf/.png/.csv
...
write_csv(
  ...
  file.path(out_dir, "figure_3_conjoint_correspondence.csv")
)
